...
const ProfileRaihan = () => {
  const hardSkills = [
    ...
    { name: 'Web Development (HTML, CSS)', level: '85%' },
    { name: 'Graphic Design', level: '85%' },
    { name: 'ReactJS & Tailwind CSS', level: '75%' },
    { name: 'Data Analysis & Statistics', level: '80%' }
  ];
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-6 sm:p-10 lg:p-12 border border-white/50 transition-all duration-300">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end -mt-24 md:-mt-32 mb-8 gap-6 lg:gap-0">
            ...
            <div className="relative group cursor-pointer shrink-0">
              <img
                src="/foto-profil.jpg" // PASTIKAN NAMA FILE FOTO KAMU BENAR DI FOLDER PUBLIC
                alt="Foto Profil Raihan Feriand Allam"
          ...
          <div className="border-b border-slate-100 pb-8 text-left">
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight">Raihan Feriand Allam</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 mb-12">
            {[
              { num: '800+', label: 'Social Media Project' },
              { num: '2026', label: 'BEM Fakultas Vokasi' },
              { num: '5+', label: 'Kepanitiaan' },
              { num: 'Junior', label: 'Web Developer' }
            ].map((stat, i) => (
            ...
            <div className="lg:col-span-1 space-y-10">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-blue-900 p-8 rounded-[2rem] shadow-xl shadow-slate-900/30 text-white relative overflow-hidden group">
                ...
                <div className="space-y-4 relative z-10">
                  {/* WhatsApp */}
                  <a href="https://wa.me/6282243216301" target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-white/10 hover:bg-emerald-500 p-3.5 rounded-2xl transition-all duration-300 border border-white/10 hover:border-emerald-400 group/btn transform hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <span className="block font-medium text-xs text-slate-300 group-hover/btn:text-emerald-100">+62 822-4321-6301</span>
                    </div>
                  </a>

                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/in/raihanferiand-7983032a6" target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-white/10 hover:bg-[#0A66C2] p-3.5 rounded-2xl transition-all duration-300 border border-white/10 hover:border-[#0A66C2] group/btn transform hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <span className="block font-medium text-xs text-slate-300 group-hover/btn:text-blue-100">Raihan Feriand A.</span>
                    </div>
                  </a>

                  {/* Email */}
                  <a href="mailto:rrhn.allam@gmail.com" className="flex items-center gap-4 bg-white/10 hover:bg-rose-500 p-3.5 rounded-2xl transition-all duration-300 border border-white/10 hover:border-rose-400 group/btn transform hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <span className="block font-medium text-xs text-slate-300 group-hover/btn:text-rose-100">rrhn.allam@gmail.com</span>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="group bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-50/50 transition-all duration-300">
                ...
                <div className="text-slate-600 leading-relaxed text-justify text-sm space-y-5">
                  <p>
                    Halo! Perkenalkan, nama saya Raihan Feriand Allam, mahasiswa Program Studi Teknologi Informasi. Saya memiliki minat yang mendalam pada dunia pengembangan antarmuka pengguna, baik dari sisi desain visual maupun pemrograman fungsional. Dalam proses mendesain, saya terbiasa menerapkan konsep User-Centered Design (UCD) menggunakan perangkat lunak Figma. Melalui pendekatan tersebut, saya mengeksplorasi penyusunan <i>user flow</i>, <i>wireframe</i> skala rendah hingga tinggi, serta <i>prototype</i> interaktif, sebagaimana yang telah saya implementasikan pada proyek perancangan antarmuka <i>website</i> penyewaan alat-alat <i>camping</i>.
                  </p>
                  <p>
                    Selain berfokus pada perancangan antarmuka, saya juga memiliki ketertarikan kuat dalam menerjemahkan desain tersebut menjadi <i>website</i> yang nyata menggunakan struktur HTML, CSS, serta ekosistem React. Sebagai buktinya, saya telah merancang dan membangun <i>website</i> portofolio pribadi secara mandiri. Di ranah akademis lainnya, saya juga antusias mempelajari analisis data statistik, termasuk penerapan analisis regresi linear berganda.
                  </p>
                  <p>
                    Di luar lingkup akademis dan teknis, saya aktif berkontribusi dalam dinamika keorganisasian kampus. Saya tergabung dalam Badan Eksekutif Mahasiswa (BEM) dan belum lama ini dipercaya penuh untuk menyusun <i>grand design</i> sebuah acara <i>farewell</i> mahasiswa, mulai dari konseptualisasi tema hingga alur eksekusi acara. Selain itu, saya kerap mengasah kreativitas melalui proyek desain independen, seperti merancang identitas visual untuk bisnis digital. Kombinasi antara kemampuan teknis, kepekaan desain UI/UX, dan keterampilan manajerial dalam berorganisasi membentuk saya menjadi individu yang adaptif dan siap berkolaborasi.
                  </p>
                </div>
              </div>

              {/* Timeline Organisasi / Proyek */}
              <div>
                ...
                <div className="space-y-8 relative before:absolute before:inset-y-0 before:left-[15px] before:w-1 before:bg-gradient-to-b before:from-blue-500 before:to-slate-200 before:rounded-full">
                  ...
                  <div className="relative pl-12 group">
                    ...
                    <div className="bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-indigo-100 group-hover:-translate-y-2">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3">
                        <h4 className="font-black text-slate-900 text-xl">Perancang Grand Design Acara Farewell</h4>
                        <span className="inline-block px-4 py-1.5 bg-blue-50 text-blue-700 text-xs font-black rounded-full mt-3 sm:mt-0 w-fit">2026</span>
                      </div>
                      <p className="text-sm font-bold text-indigo-600 mb-4">Badan Eksekutif Mahasiswa (BEM)</p>
                      <p className="text-slate-600 text-sm leading-relaxed font-medium">Bertanggung jawab penuh dalam menyusun dan mengembangkan grand design untuk program farewell mahasiswa, meliputi pembuatan tema, penentuan linimasa, hingga struktur acara secara keseluruhan.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-12 group">
                    ...
                    <div className="bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-indigo-100 group-hover:-translate-y-2">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3">
                        <h4 className="font-black text-slate-900 text-xl">UI/UX Designer (Project Based)</h4>
                        <span className="inline-block px-4 py-1.5 bg-blue-50 text-blue-700 text-xs font-black rounded-full mt-3 sm:mt-0 w-fit">2026</span>
                      </div>
                      <p className="text-sm font-bold text-indigo-600 mb-4">Proyek Website Alat Camping</p>
                      <p className="text-slate-600 text-sm leading-relaxed font-medium">Menerapkan prinsip User-Centered Design (UCD) dalam merancang antarmuka platform penyewaan alat camping. Proses mencakup identifikasi target pengguna, perancangan user journey map, task analysis, hingga pembuatan wireframe fungsional.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-12 group">
                    ...
                    <div className="bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-2">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3">
                        <h4 className="font-black text-slate-900 text-xl">Freelance Graphic Designer</h4>
                        <span className="inline-block px-4 py-1.5 bg-slate-100 text-slate-600 text-xs font-black rounded-full mt-3 sm:mt-0 w-fit">2026</span>
                      </div>
                      <p className="text-sm font-bold text-slate-500 mb-4">Gepeng Store</p>
                      <p className="text-slate-600 text-sm leading-relaxed font-medium">Dipercaya untuk merancang identitas visual dan pembuatan logo untuk toko digital yang bergerak di bidang layanan sosial media dan akun permainan daring.</p>
                    </div>
                  </div>
